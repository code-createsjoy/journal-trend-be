 ...
 * Tìm kiếm/lọc: search.
 */
    PageResponse<PaperDetailResponse> search(String q, String searchType, Long topicId, Long authorId, Integer fromYear, Integer toYear, Integer month, String category, Integer minCitations, Long journalId, Pageable pageable);
