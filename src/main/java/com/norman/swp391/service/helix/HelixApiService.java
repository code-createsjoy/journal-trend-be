    ...
    public List<HelixPaper> listPapers(String category, String excludeId, Integer limit, String q, Long keywordId) {
        ...
        if (keywordId != null) {
            page = paperRepository.search(
                    PaperStatus.ACTIVE, PaperReviewStatus.NONE, query, null, keywordId, null, null, null, null, null, null, null, pageable);
        } else if (query == null) {
            page = paperRepository.search(
                    PaperStatus.ACTIVE, PaperReviewStatus.NONE, null, null, null, null, null, null, null, null, null, null, pageable);
        } else {
            page = paperRepository.search(
                    PaperStatus.ACTIVE, PaperReviewStatus.NONE, query, null, null, null, null, null, null, null, null, null, pageable);
        }
